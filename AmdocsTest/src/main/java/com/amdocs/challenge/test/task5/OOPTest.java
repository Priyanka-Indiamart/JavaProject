...
public class OOPTest {
	...
	public void testToString() throws Exception {
		createComments();
		assertEquals("The toString method should return the correct hierarchy (no reply):", "hello by User 1",
				user1Comment.toString());
		assertEquals("The toString method should return the correct hierarchy (reply):",
				"hi by User 2 (replied to User 1)", user2Comment.toString());
		...
		assertEquals("The toString method should reflect reference changes:", "hello by User One",
				user1Comment.toString());
		assertEquals("The toString method should reflect reference changes:", "hi by User Two (replied to User One)",
				user2Comment.toString());
	}
}
